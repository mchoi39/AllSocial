...
public class GithubFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view=inflater.inflate(R.layout.activity_github_fragment, container, false);
        mAuth = FirebaseAuth.getInstance();
        store = FirebaseFirestore.getInstance();
        etGithubLink = (EditText) view.findViewById(R.id.fragment_github_et_github_link);
        linkToQRbtn = (Button) view.findViewById(R.id.fragment_github_btn_github_link_to_QR);
        ivGithubQR = (ImageView) view.findViewById(R.id.fragment_github_iv_github_QR);
            ...
            docRef.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                ...
                public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                    if (task.isSuccessful()) {
                        ...
                        if (document.exists()) {
                            String val = document.getString("github");
                            if (val != null && val.length() > 0){
                                ...
                                try {
                                    ...
                                    ivGithubQR.setImageBitmap(bitmap);
                                } catch (WriterException e) {
                                    System.out.println("Not working");
                                    e.printStackTrace();
                                }
                            } else {
                                ivGithubQR.setImageResource(R.drawable.github_512);
                            }
        ...
        linkToQRbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String link= etGithubLink.getText().toString();
                ...
                if (Patterns.WEB_URL.matcher(link.toLowerCase()).matches()) {
                    ...
                    map.put("github", link.toLowerCase());
