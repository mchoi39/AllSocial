...
public class InstagramFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view=inflater.inflate(R.layout.activity_instagram_fragment, container, false);
        mAuth = FirebaseAuth.getInstance();
        store = FirebaseFirestore.getInstance();
        etInstagramLink = (EditText) view.findViewById(R.id.fragment_instagram_et_instagram_link);
        linkToQRbtn = (Button) view.findViewById(R.id.fragment_instagram_btn_instagram_link_to_QR);
        ivInstagramQR = (ImageView) view.findViewById(R.id.fragment_instagram_iv_instagram_QR);
            ...
            docRef.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                ...
                public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                    if (task.isSuccessful()) {
                        ...
                        if (document.exists()) {
                            String val = document.getString("instagram");
                            if (val != null && val.length() > 0){
                                ...
                                try {
                                    ...
                                    ivInstagramQR.setImageBitmap(bitmap);
                                } catch (WriterException e) {
                                    System.out.println("Not working");
                                    e.printStackTrace();
                                }
                            } else {
                                ivInstagramQR.setImageResource(R.drawable.instagram_512px);
                            }
        ...
        linkToQRbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String link= etInstagramLink.getText().toString();
                ...
                if (Patterns.WEB_URL.matcher(link.toLowerCase()).matches()) {
                    ...
                    map.put("instagram", link.toLowerCase());
