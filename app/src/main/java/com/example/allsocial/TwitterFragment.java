...
public class TwitterFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view=inflater.inflate(R.layout.activity_twitter_fragment, container, false);
        mAuth = FirebaseAuth.getInstance();
        store = FirebaseFirestore.getInstance();
        etTwitterLink = (EditText) view.findViewById(R.id.fragment_twitter_et_twitter_link);
        linkToQRbtn = (Button) view.findViewById(R.id.fragment_twitter_btn_twitter_link_to_QR);
        ivTwitterQR = (ImageView) view.findViewById(R.id.fragment_twitter_iv_twitter_QR);
            ...
            docRef.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                ...
                public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                    if (task.isSuccessful()) {
                        ...
                        if (document.exists()) {
                            String val = document.getString("twitter");
                            if (val != null && val.length() > 0){
                                ...
                                try {
                                    ...
                                    ivTwitterQR.setImageBitmap(bitmap);
                                } catch (WriterException e) {
                                    System.out.println("Not working");
                                    e.printStackTrace();
                                }
                            } else {
                                ivTwitterQR.setImageResource(R.drawable.twitter_512px);
                            }
        ...
        linkToQRbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String link= etTwitterLink.getText().toString();
                ...
                if (Patterns.WEB_URL.matcher(link.toLowerCase()).matches()) {
                    ...
                    map.put("twitter", link.toLowerCase());
